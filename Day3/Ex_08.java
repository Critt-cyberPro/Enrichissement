...
public static void main(String[] args) {
    ...
    System.out.println("La moyenne de André est : "+moyÉtu(iNote, 2));
    System.out.println("La moyenne de Julie est : "+moyÉtu(iNote, 3));
    System.out.println("La moyenne de Brigitte est : "+moyÉtu(iNote, 4));
    System.out.println("La moyenne de Anne est : "+moyÉtu(iNote, 5));
    System.out.println("La moyenne de Olivier est : "+moyÉtu(iNote, 6));
    System.out.println("La moyenne de Simon est : "+moyÉtu(iNote, 7));
    System.out.println("La moyenne de Nadine est : "+moyÉtu(iNote, 8));
    
}
public static double moyEval(Object [][] iNote,int iLigne) {
    double dMoy,dSomm=0;
    for (int i=1; i< iNote[0].length; i++) {
